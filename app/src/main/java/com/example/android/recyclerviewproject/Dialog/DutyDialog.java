...
public class DutyDialog extends AppCompatDialogFragment {

    private DutyDialogListener listener;
            ...
            public void onShow(final DialogInterface dialog) {
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        listener.saveDuty(name, myItem.getPos());
                        openEventDialog();
                    }
                });
    ...
    public void onAttach(Context context) {
        ...
        try{
            listener =(DutyDialogListener) context;
    ...
    private void initViews(View myView){
        ...
        title.setText("Edit Duties & Additional Info");
        input = myView.findViewById(R.id.input);
        input.setText(myItem.getMyDuties());
        layout = myView.findViewById(R.id.main_dialog);
        layout.setBackgroundResource(colorChoices[colorCode]);
    }

    public interface DutyDialogListener{
        void saveDuty(String temp, int pos);
    }
}
